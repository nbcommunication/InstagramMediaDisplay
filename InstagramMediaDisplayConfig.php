...
/**
 * Instagram Media Display Configuration
 *
 */

class InstagramMediaDisplayConfig extends ModuleConfig {
	...
	public function getInputfields() {
		...
		// Add assets
		$urlAsset = "{$config->urls->site}modules/{$instagram->className}/{$this->className}";
